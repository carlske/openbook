...
const BookCard = ({ book, language }: BookCardProps) => {
  return (
    <Card className="w-[300px] cursor-pointer border-2 border-black shadow-[4px_4px_0_black] dark:border-white dark:shadow-[4px_4px_0_white]">
      <Image src="/bookmark.svg" alt="Bookmark" width={24} height={24} className="relative top-[-2em] left-0" />

      <div className="mb-4 flex h-48 w-full items-center justify-center text-black">
